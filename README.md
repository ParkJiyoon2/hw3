32187345 양해찬 - 가상 메모리 시뮬레이션

시뮬레이션 구현 - 과제 옵션의 ‘C’ 단계를 구현했습니다.   
컴파일하려면, make를 실행합니다. (Makefile이 작성되어 있습니다.)

▶ make: 'vm_simulator' is up to date. 오류가 발생하면 ‘make clean’ 후 재실행합니다.
...
```
user26@os-lecture--1:~/hw3$ ./vm_simulator
PID0 0x327b23c6 : written inputfile0.raw 1048579  bytes.
PID1 0x6b8b4567 : written inputfile1.raw 9295  bytes.
Entering interactive console. Ctrl+c to quit.
input) pid addr_lower_hex size
example) 3 0xcafebabe 16

> 1 0x6b8b4567  32

(0x6b8b4567) 0x23 [#] 0x20 [ ] 0x68 [h] 0x77 [w] 0x33 [3] 0x2c [,] 0x20 [ ] 0x56 [V]
